...
def parse_args():
    ...
    parser.add_argument('--dataset_path', type=str, default='Real_Datasets/smotifiedCTGAN_data_class1.csv')
    parser.add_argument('--sample_dir', type=str, default='samples')
    parser.add_argument('--checkpoint_dir', type=str, default='checkpoints')
    parser.add_argument('--save_name', type=str, default='vae_ctabgan.pt')
    parser.add_argument('--preprocessed_path', type=str, default='preprocess/preprocessed_smotified.csv')
    parser.add_argument('--transformer_path', type=str, default='preprocess/transformer/transformer_smotified.pkl')
    parser.add_argument('--dataprep_path', type=str, default='preprocess/dataprep/dataprep_smotified.pkl')
    parser.add_argument("--real_activate_until_epoch", type=int, default=40,
